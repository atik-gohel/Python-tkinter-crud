...
nextbtn = Button(win, command=nDisplay, text="Next", font=("times",14), width=8, bg="#41A317", activeforeground="#fff", activebackground="#52D017", foreground="white",  bd=0)
nextbtn.place(x=135, y=510)

previousbtn = Button(win,  command=pDisplay, text="Previous", font=("times",14), width=8, bg="#41A317", activeforeground="#fff", activebackground="#52D017", foreground="white",  bd=0)
